...
# This is a classic topological sorting question. One way to think about this problem is to think about how would you
# go about solving it manually? We can divide it into these two steps:
#
# Put all courses with no pre-requisites into our todo list.
#  For each course C in the todo list, find each course D
#  which have C as a prerequisite and remove C from its list. Add D to the todo list. If in the end we couldn't take
#   some courses, this means that were was a circular dependency.
