...
#
# Solution We can do this by applying a bitmask over all the even bits, and another one over all the odd bits. Then
# we shift the even bitmask right by one and the odd bitmask left by one.
