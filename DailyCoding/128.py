...
# This will run in O(2n) time, since for each call we're recursively calling ourselves twice. This should also take O(n) space since the function call stack goes n calls deep.