...
#
# Solution
# This looks like a problem that is ripe for solving with recursion. First, let's try to think of a recurrence
# we can use for this problem. We can try some cases:
...
#
# All the following code does is repeat the same computation as above except starting from the base case and building
# up the solution. Since each iteration takes O(1), the whole algorithm now takes O(n).
