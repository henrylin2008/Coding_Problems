...
#
# Solution
# This problem becomes clearer if we sort the intervals by the starting points. For example, intervals [[10,
# 20], [1, 6], [3, 8], [7, 12]] should become [[1, 6], [3, 8], [7, 12], [10, 20]].
#
...
# interval.
#
# In the above example, the intersection of [[1, 6], [3, 8]] is [3, 6] while the intersection of [7, 12], [10,
# 20] is [10, 12].
...
# The main while loop takes O(n) since we iterate through the intervals, and sorting the interval takes O(n log n),
# so this takes O(n log n) time.
