...
#
# Now we know that we've seen one 1 in the middle column and two 1s in a row in the last column, so we can infer that
# the largest subrectangle of 1s so far has area 2.
#
