...
#
# Solution
# Even though the question states O(n), in an interview it's always useful to first write out a brute force solution,
# which may provide us with some insight on some deeper structure in the problem.
#
