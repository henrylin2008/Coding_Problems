...
# # We'll initialize low and mid both to 0, and high to len(array) - 1 so that our unknown section is the whole array,
# as before. To maintain this invariant, we should do the following:
#
# Look at array[mid]:
