...
# Let’s try to understand this with Example-2 mentioned above. In the following array, what are the first numbers out
# of sorting order from the beginning and the end of the array:
#     [1, 3, 2, 0, -1, 7, 10]
...
#   4. Similarly, extend the subarray from the end to include any number which is smaller than the maximum of the
#      subarray.
