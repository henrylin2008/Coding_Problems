...
# characters in the input string (e.g., 26 for English letters), we can say that the algorithm runs in fixed space O(
# 1); in this case, we can use a fixed-size array instead of the HashMap.
