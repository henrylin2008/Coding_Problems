...
# A quick note on "unweighted". Sometimes, graph's edges can have weight. For example, a graph that represents city
# connections and edges' weights represent the distance between cities.
#
